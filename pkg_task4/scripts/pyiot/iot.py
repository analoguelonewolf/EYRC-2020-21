...
# -----------------  MQTT PUB -------------------
def mqtt_publish(arg_broker_url, arg_broker_port, arg_mqtt_topic, arg_mqtt_message, arg_mqtt_finalx, arg_mqtt_finaly, arg_mqtt_finaltheta, arg_mqtt_qos):
    try:        
        ...
        mqtt_client.publish(arg_mqtt_topic, arg_mqtt_message+ " : "+ "x="+ arg_mqtt_finalx+ " y=" + arg_mqtt_finaly+ " z=" + arg_mqtt_finaltheta, arg_mqtt_qos)
        time.sleep(0.1) # wait
